...
def app():
    ...
    st.text("""
    This application allows you to calculate the average concentration of lead (Pb) that could be absorbed by the soil in the event of a lead leak from a perovskite solar panel.
