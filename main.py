...
def app():
    ...
    with st.form(key='pannel form'):
        ...
        #Concentration
        input_user_pb_concentration = float(st.number_input(label='Pb concentration [g/m2] - max concentration is 3.000g/m2',value=0.9, min_value=0.010, max_value=3,format="%.3f",step=0.001))
        st.write("---") 
